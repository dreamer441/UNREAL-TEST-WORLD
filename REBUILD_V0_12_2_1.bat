...
echo ============================================================
echo   AMADEUS v0.12.2.1 - speed ring zero fix
echo ============================================================
echo.
...
echo.
echo Expected speed preview:
echo   0 speed = 0 rings
 echo   low speed = 1 ring
 echo   medium speed = 2 rings
 echo   high speed = 3 rings
 echo.
