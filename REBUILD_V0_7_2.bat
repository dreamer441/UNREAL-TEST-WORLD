...
echo ============================================================
echo  ProjectX / AMADEUS Gameplay v0.7.2 - rebuild fix
echo ============================================================
echo.
...
echo Unreal will perform the rebuild using its own bundled toolchain.
echo If asked to rebuild missing modules, choose YES.
start "" "TESTUNREALPROJECT.uproject"

echo.
echo Project opened. If Unreal reports a compiler error, send:
